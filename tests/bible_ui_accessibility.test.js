...
assert.match(bible, /\.app-version \{[\s\S]*padding: var\(--display-panel-gap\) 16px max\(2px, env\(safe-area-inset-bottom, 0px\)\);[\s\S]*font-size: max\(12px, calc\(var\(--display-control-font-size\) - 6px\)\);[\s\S]*white-space: nowrap;/);

...
assert.match(bible, /--ui-control-font-size: 20px;/);
assert.match(bible, /document\.documentElement\.style\.setProperty\('--ui-control-font-size', size \+ 'px'\);/);
...
assert.match(bible, /\.bottom-chrome \{[\s\S]*left: 12px;[\s\S]*right: 12px;[\s\S]*bottom: calc\(8px \+ env\(safe-area-inset-bottom, 0px\)\);[\s\S]*align-items: center;[\s\S]*padding: 6px;[\s\S]*min-height: 52px;[\s\S]*background: var\(--float-nav-bg\);[\s\S]*border: var\(--card-border\);[\s\S]*border-radius: var\(--radius-md\);[\s\S]*box-shadow: var\(--float-nav-shadow\);[\s\S]*backdrop-filter: var\(--hdr-blur\);[\s\S]*transform: translateY\(0\);[\s\S]*opacity: 1;[\s\S]*transition: transform 220ms ease, opacity 220ms ease;/);
...
assert.match(bible, /\.floating-nav button \{[\s\S]*font-size: var\(--ui-control-font-size\);/);
assert.match(bible, /\.bottom-action-button \{[\s\S]*font-size: var\(--ui-control-font-size\);/);
assert.match(bible, /\.dd-item \{[\s\S]*font-size: var\(--ui-control-font-size\);/);
assert.match(bible, /\.theme-mode-button \{[\s\S]*font-size: var\(--ui-control-font-size\);/);
assert.match(bible, /\.book-name-en \{ font-size: var\(--ui-control-font-size\);/);
assert.match(bible, /\.book-name-ko \{ font-size: max\(13px, calc\(var\(--ui-control-font-size\) - 3px\)\);/);
assert.match(bible, /\.chapters-header \{ font-size: calc\(var\(--ui-control-font-size\) \+ 2px\);/);
assert.match(bible, /\.chapter-btn \{[\s\S]*font-size: var\(--ui-control-font-size\);/);
assert.match(bible, /\.search-input \{[\s\S]*font-size: var\(--ui-control-font-size\);/);
assert.match(bible, /\.search-hist-item \.sh-query \{ flex: 1; font-size: var\(--ui-control-font-size\);/);
assert.match(bible, /\.search-text \{ font-size: max\(15px, calc\(var\(--ui-control-font-size\) - 2px\)\);/);

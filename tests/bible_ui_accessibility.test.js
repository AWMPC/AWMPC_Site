...
assert.match(bible, /\.verse \{[\s\S]*border-radius: var\(--radius-sm\);[\s\S]*border: 2px solid transparent;[\s\S]*transition-property: background, border-color, box-shadow, padding, border-width;[\s\S]*transition-duration: 0\.2s;[\s\S]*white-space: normal;[\s\S]*overflow-wrap: anywhere;/);
...
assert.match(bible, /\.footnote-body \{[\s\S]*margin: 0 0 0 20px;[\s\S]*max-height: 0;[\s\S]*opacity: 0;[\s\S]*overflow: hidden;[\s\S]*background: var\(--note-bg\);[\s\S]*border: 0 solid color-mix\(in srgb, var\(--note-border\) 45%, transparent\);[\s\S]*border-left-width: 0;[\s\S]*border-radius: var\(--radius-sm\);[\s\S]*transition-property: opacity, max-height, margin, padding, border-width, transform;[\s\S]*transition-duration: 180ms, 220ms, 220ms, 220ms, 220ms, 220ms;/);

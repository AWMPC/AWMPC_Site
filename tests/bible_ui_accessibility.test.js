...
assert.match(bible, /\.profile-card\.signed-out \{[\s\S]*overflow: visible;[\s\S]*min-height: 0;[\s\S]*padding: var\(--display-panel-padding\);/);
...
assert.match(bible, /\.profile-card \.dd-signin-button \{[\s\S]*width: 100%;[\s\S]*min-height: var\(--display-control-height\);[\s\S]*justify-content: center;[\s\S]*border-bottom: 0;/);

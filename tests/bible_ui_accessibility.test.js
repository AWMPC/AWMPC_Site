...
assert.match(bible, /\.verse \{[\s\S]*border-radius: var\(--radius-sm\);[\s\S]*border: 2px solid transparent;[\s\S]*transition: background 0\.2s ease, border-color 0\.2s ease, box-shadow 0\.2s ease, padding 0\.2s ease, border-width 0\.2s ease;[\s\S]*white-space: normal;[\s\S]*overflow-wrap: anywhere;/);
...
assert.match(bible, /\.fab-panel \{[\s\S]*display: flex;[\s\S]*position: fixed;[\s\S]*right: 12px;[\s\S]*bottom: var\(--bottom-chrome-clearance\);[\s\S]*max-height: calc\(100dvh - var\(--bottom-chrome-clearance\) - 12px\);[\s\S]*overflow-y: auto;[\s\S]*overscroll-behavior: contain;[\s\S]*gap: var\(--display-panel-gap\);[\s\S]*padding: var\(--display-panel-padding\);[\s\S]*background: var\(--float-nav-bg\);[\s\S]*border: var\(--card-border\);[\s\S]*border-radius: var\(--radius-md\);[\s\S]*box-shadow: var\(--float-nav-shadow\);[\s\S]*backdrop-filter: var\(--hdr-blur\);[\s\S]*-webkit-backdrop-filter: var\(--hdr-blur\);[\s\S]*isolation: isolate;[\s\S]*transition: opacity 180ms ease, transform 180ms ease, visibility 0s linear 180ms;/);
...
assert.match(bible, /\.bottom-history-menu \{[\s\S]*position: fixed;[\s\S]*right: 12px;[\s\S]*bottom: var\(--bottom-chrome-clearance\);[\s\S]*width: min\(420px, calc\(100vw - 24px\)\);[\s\S]*max-height: calc\(100dvh - var\(--bottom-chrome-clearance\) - 12px\);[\s\S]*display: grid;[\s\S]*grid-auto-rows: minmax\(0, auto\);[\s\S]*overflow-y: auto;[\s\S]*overscroll-behavior: contain;[\s\S]*background: var\(--float-nav-bg\);[\s\S]*backdrop-filter: var\(--hdr-blur\);[\s\S]*-webkit-backdrop-filter: var\(--hdr-blur\);[\s\S]*isolation: isolate;[\s\S]*z-index: 132;[\s\S]*opacity: 0;[\s\S]*visibility: hidden;[\s\S]*pointer-events: none;[\s\S]*transform: translateY\(6px\) scale\(\.98\);[\s\S]*transition: opacity 180ms ease, transform 180ms ease, visibility 0s linear 180ms;/);
...
assert.match(bible, /\.profile-card \.dd-signin-button \{[\s\S]*width: 100%;[\s\S]*min-height: calc\(var\(--display-control-height\) \+ \(var\(--display-panel-padding\) \* 2\)\);[\s\S]*justify-content: center;[\s\S]*border: 0;[\s\S]*border-bottom: 0;[\s\S]*border-radius: var\(--radius-sm\);[\s\S]*background: transparent;[\s\S]*box-shadow: inset 0 0 0 1px transparent, 0 1px 8px transparent;[\s\S]*transition: background 180ms ease, color 180ms ease, box-shadow 180ms ease, transform 120ms ease;/);
...
assert.match(bible, /html\.theme-transitioning,[\s\S]*html\.theme-transitioning \.bottom-chrome,[\s\S]*html\.theme-transitioning \.bottom-history-menu,[\s\S]*transition:[\s\S]*background 260ms ease,[\s\S]*color 260ms ease,/);

...
assert.match(bible, /<div class="fab-section-label">Recent reading<\/div>[\s\S]*<div id="history-menu" class="fab-history-menu"><\/div>[\s\S]*<button class="dd-item" id="btn-search" type="button">[\s\S]*<span class="dd-label">Search<\/span>[\s\S]*<div class="app-version">Version <span id="app-version">3\.0\.0<\/span><\/div>/);
...
assert.match(bible, /\.fab-main \.profile-avatar \{[\s\S]*width: 100%;[\s\S]*height: 100%;[\s\S]*border-radius: inherit;[\s\S]*object-fit: cover;[\s\S]*border: 0;/);

...
assert.match(bible, /\.verse \{[\s\S]*border: 2px solid transparent;[\s\S]*transition-property: background, border-color, box-shadow, padding, border-width;[\s\S]*transition-duration: 0\.2s;[\s\S]*white-space: normal;[\s\S]*overflow-wrap: anywhere;/);
...
assert.match(bible, /\.footnote-body \{[\s\S]*max-height: 0;[\s\S]*opacity: 0;[\s\S]*overflow: hidden;[\s\S]*background: var\(--note-bg\);[\s\S]*transition-property: opacity, max-height, margin, padding, border-width, transform;[\s\S]*transition-duration: 180ms, 220ms, 220ms, 220ms, 220ms, 220ms;/);
...
assert.match(bible, /\.fab-panel \{[\s\S]*display: flex;[\s\S]*position: fixed;[\s\S]*isolation: isolate;[\s\S]*transition-property: opacity, transform, visibility;[\s\S]*transition-duration: 180ms, 180ms, 0s;[\s\S]*transition-delay: 0s, 0s, 180ms;/);
...
assert.match(bible, /\.bottom-chrome \{[\s\S]*left: 12px;[\s\S]*transform: translateY\(0\);[\s\S]*opacity: 1;[\s\S]*transition-property: transform, opacity;[\s\S]*transition-duration: 220ms;/);
...
assert.match(bible, /\.bottom-history-menu \{[\s\S]*position: fixed;[\s\S]*transform: translateY\(6px\) scale\(\.98\);[\s\S]*transition-property: opacity, transform, visibility;[\s\S]*transition-duration: 180ms, 180ms, 0s;[\s\S]*transition-delay: 0s, 0s, 180ms;/);
assert.match(bible, /\.bottom-history-menu\.open \{[\s\S]*opacity: 1;[\s\S]*transform: translateY\(0\) scale\(1\);[\s\S]*transition-property: opacity, transform, visibility;[\s\S]*transition-duration: 180ms, 180ms, 0s;/);
...
assert.match(bible, /\.marquee-line\.is-marquee \{[\s\S]*animation: marquee-mask-breathe 3s var\(--motion-ease\) infinite alternate;/);
...
assert.match(bible, /\.profile-card \.dd-signin-button \{[\s\S]*width: 100%;[\s\S]*transition-property: background, color, box-shadow, transform;[\s\S]*transition-duration: 180ms, 180ms, 180ms, 120ms;/);
